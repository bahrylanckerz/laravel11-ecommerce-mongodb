                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">Add New CMS Pages</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ url('admin/create-cms-pages') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter title" value="{{ old('title') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror"
                                            placeholder="Enter description here" cols="30" rows="10">{{ old('description') }}</textarea>
